...
///////////////////SALES SECTION////////////////////SALES SECTION////////////////////////SALES SECTION//////////////////////SALES SECTION///////////////////SALES SECTION/
    ...
    public void lineChart(ActionEvent event) {
        ...
        /*String jan,janCosts,feb,febCost,mar,marCost,april,aprCost, may,mayCost, jun = "0.0",junCost, jul,julCost, aug,augCost, sep,septCost, oct,octCost, nov,novCost, dec,decCost;
        String date = getDate();
        if (date.substring(0,3).equalsIgnoreCase("jan")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";

                Connection connection = DatabaseConnection.connection();
                ResultSet resultSet = connection.createStatement().executeQuery(sql);
                jan = resultSet.getString(1);



                if (jan != null)series.getData().add(new XYChart.Data<>("Jan", Double.parseDouble(jan)));

            } catch (SQLException e) {
                e.printStackTrace();
            }

        }else if (date.substring(0,3).equalsIgnoreCase("feb")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Feb%'";

                resultSet = connection.createStatement().executeQuery(sql);
                feb = resultSet.getString(1);



                if (jan != null)series.getData().add(new XYChart.Data<>("Jan", Double.parseDouble(jan)));
                if (feb != null) series.getData().add(new XYChart.Data<>("Feb", Double.parseDouble(feb)));

            } catch (SQLException e) {
                e.printStackTrace();
            }

        }else if (date.substring(0,3).equalsIgnoreCase("mar")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Mar%'";

                resultSet = connection.createStatement().executeQuery(sql);
                mar = resultSet.getString(1);
                ...
                if (mar != null) series.getData().add(new XYChart.Data<>("Mar", Double.parseDouble(mar)));

            } catch (SQLException e) {
                e.printStackTrace();
            }

        }else if (date.substring(0,3).equalsIgnoreCase("apr")){
            try {
                String sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Jan%' and sales.itermid == iterms.itermid";

                Connection connection = DatabaseConnection.connection();
                ResultSet resultSet = connection.createStatement().executeQuery(sql);
                jan = resultSet.getString(1);
                janCosts = resultSet.getString(2);


                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Feb%' and sales.itermid == iterms.itermid";

                resultSet = connection.createStatement().executeQuery(sql);
                feb = resultSet.getString(1);
                febCost = resultSet.getString(2);


                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Mar%' and sales.itermid == iterms.itermid";

                resultSet = connection.createStatement().executeQuery(sql);
                mar = resultSet.getString(1);
                marCost = resultSet.getString(2);


                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Apr%' and sales.itermid == iterms.itermid";

                resultSet = connection.createStatement().executeQuery(sql);
                april = resultSet.getString(1);
                aprCost = resultSet.getString(2);




                if (jan != null)series.getData().add(new XYChart.Data<>("Jan", Double.parseDouble(jan)));
                if (janCosts != null)seriesCost.getData().add(new XYChart.Data<>("Jan", Double.parseDouble(janCosts)));
                if (janCosts != null && jan != null)seriesProfit.getData().add(new XYChart.Data<>("Jan", Double.parseDouble(jan)-Double.parseDouble(janCosts)));


                if (feb != null) series.getData().add(new XYChart.Data<>("Feb", Double.parseDouble(feb)));
                if (febCost != null) seriesCost.getData().add(new XYChart.Data<>("Feb", Double.parseDouble(febCost)));
                if (febCost != null && feb != null)seriesProfit.getData().add(new XYChart.Data<>("Feb", Double.parseDouble(feb)-Double.parseDouble(febCost)));

                if (mar != null) series.getData().add(new XYChart.Data<>("Mar", Double.parseDouble(mar)));
                if (marCost != null) seriesCost.getData().add(new XYChart.Data<>("Mar", Double.parseDouble(marCost)));
                if (marCost != null && mar != null)seriesProfit.getData().add(new XYChart.Data<>("Mar", Double.parseDouble(mar)-Double.parseDouble(marCost)));

                if (april != null) series.getData().add(new XYChart.Data<>("Apr", Double.parseDouble(april)));
                if (aprCost != null) seriesCost.getData().add(new XYChart.Data<>("Apr", Double.parseDouble(aprCost)));
                if (aprCost != null && april != null)seriesProfit.getData().add(new XYChart.Data<>("Apr", Double.parseDouble(april)-Double.parseDouble(aprCost)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("may")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Apr%'";

                resultSet = connection.createStatement().executeQuery(sql);
                april = resultSet.getString(1);

                sql = "select sum(total) from sales where salesdate like '%May%'";

                resultSet = connection.createStatement().executeQuery(sql);
                may = resultSet.getString(1);
                ...
                if (may != null) series.getData().add(new XYChart.Data<>("May", Double.parseDouble(may)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("jun")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Jun%'";

                resultSet = connection.createStatement().executeQuery(sql);
                jun = resultSet.getString(1);
                ...
                if (jun != null) series.getData().add(new XYChart.Data<>("Jun", Double.parseDouble(jun)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("jul")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Jul%'";

                resultSet = connection.createStatement().executeQuery(sql);
                jul = resultSet.getString(1);
                ...
                if (jul != null) series.getData().add(new XYChart.Data<>("Jul", Double.parseDouble(jul)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("aug")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Aug%'";

                resultSet = connection.createStatement().executeQuery(sql);
                aug = resultSet.getString(1);
                ...
                if (aug != null) series.getData().add(new XYChart.Data<>("Jul", Double.parseDouble(aug)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("sep")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Sep%'";

                resultSet = connection.createStatement().executeQuery(sql);
                sep = resultSet.getString(1);
                ...
                if (sep != null) series.getData().add(new XYChart.Data<>("Jul", Double.parseDouble(sep)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("oct")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Oct%'";

                resultSet = connection.createStatement().executeQuery(sql);
                oct = resultSet.getString(1);
                ...
                if (oct != null) series.getData().add(new XYChart.Data<>("Jul", Double.parseDouble(oct)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("nov")){
            try {
                String sql = "select sum(total) from sales where salesdate like '%Jan%'";
                ...
                sql = "select sum(total) from sales where salesdate like '%Nov%'";

                resultSet = connection.createStatement().executeQuery(sql);
                nov = resultSet.getString(1);
                ...
                if (aug != null) series.getData().add(new XYChart.Data<>("Aug", Double.parseDouble(aug)));

                if (sep != null) series.getData().add(new XYChart.Data<>("Sep", Double.parseDouble(sep)));

                if (oct != null) series.getData().add(new XYChart.Data<>("Oct", Double.parseDouble(oct)));

                if (nov != null) series.getData().add(new XYChart.Data<>("Nov", Double.parseDouble(nov)));
        ...
        }else if (date.substring(0,3).equalsIgnoreCase("dec")){
            try {
                String sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Jan%' and sales.itermid == iterms.itermid";
                ...
                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%May%' and sales.itermid == iterms.itermid";

                resultSet = connection.createStatement().executeQuery(sql);
                may = resultSet.getString(1);
                mayCost = resultSet.getString(2);

                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Jun%' and sales.itermid == iterms.itermid";
                resultSet = connection.createStatement().executeQuery(sql);
                jun = resultSet.getString(1);
                junCost = resultSet.getString(2);

                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Jul%' and sales.itermid == iterms.itermid";
                resultSet = connection.createStatement().executeQuery(sql);
                jul = resultSet.getString(1);
                julCost = resultSet.getString(2);

                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Aug%' and sales.itermid == iterms.itermid";
                resultSet = connection.createStatement().executeQuery(sql);
                aug = resultSet.getString(1);
                augCost = resultSet.getString(2);

                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Sep%' and sales.itermid == iterms.itermid";
                resultSet = connection.createStatement().executeQuery(sql);
                sep = resultSet.getString(1);
                septCost = resultSet.getString(2);

                sql = "select sum(sales.total),sum(iterms.costprice) from sales,iterms where salesdate like '%Oct%' and sales.itermid == iterms.itermid";
                resultSet = connection.createStatement().executeQuery(sql);
                oct = resultSet.getString(1);
                octCost = resultSet.getString(2);
                ...
                sql = "select sum(total) from sales where salesdate like '%Dec%'";

                resultSet = connection.createStatement().executeQuery(sql);
                dec = resultSet.getString(1);
                ...
                if (dec != null) series.getData().add(new XYChart.Data<>("Dec", Double.parseDouble(dec)));
